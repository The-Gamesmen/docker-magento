...
return [
    'modules' => [
        ...
        'Wyomind_Framework' => 1,
        'Wyomind_EstimatedDeliveryDate' => 0,
        'Wyomind_DynamicCategory' => 1,
    ...
    'scopes' => [
        ...
        'stores' => [
            ...
            'ebaythegamesmenau' => [
                'store_id' => '2',
                'code' => 'ebaythegamesmenau',
                'website_id' => '1',
                'group_id' => '1',
                'name' => 'eBay (thegamesmenau)',
                'sort_order' => '5',
                'is_active' => '0',
            ],
            'amazon_au' => [
    ...
    'system' => [
        'default' => [
            ...
            'hyva_luma_checkout' => [
                'general' => [
                    'enable' => '1',
//                    'theme_full_path' => 'frontend/Gamesmen/checkout',
                ],
            ],
            'general' => [
                'country' => [
...
',
                ...
                'markup' => [
                    'product' => [
                        //'rs_enabled' => '1',
                        //'rs_enabled_for_specific_product' => '1',
                        'best_rating' => null,
                        'add_reviews' => '0',
                        'disable_default_review' => '1',
                        'use_multiple_offer' => '0',
                        //'description_code' => 'gmen_desc_manufacturerdescription',
                        //'crop_html_in_description' => '1',
                        //'sku_enabled' => '1',
                        'sku_code' => 'sku',
                        //'category_enabled' => '1',
                        'category_deepest' => '1',
                        // 'color_enabled' => '1',
                        // 'color_code' => 'gmen_colour_simple',
                        // 'manufacturer_enabled' => '1',
                        // 'manufacturer_code' => 'gmen_desc_manufacturer',
                        // 'brand_enabled' => '1',
                        // 'brand_code' => 'gmen_brands',
                        //'model_enabled' => '1',
                        'model_code' => 'gmen_mpn',
                        'gtin_enabled' => '1',
                        'gtin_code' => 'gmen_upc',
...
"--": "-"'
            ...
            'shipping' => [
                'origin' => [
                    ...
                    'postcode' => '2210',
                    'city' => 'Riverwood',
                    'street_line1' => 'Unit 3/115 Bonds Road',
                    'street_line2' => null,
                ],
                'shipping_policy' => [
            ...
            'mana_core' => [
                ...
                'debug' => [
                    'product_list_select' => null,
                    'profiler' => null,
                ],
                'log' => [
                    'layout_xml' => null,
                    'page_queries' => null,
                    'query_stack_trace' => null,
                    'filter_index_queries' => null,
                    'product_collection_queries' => null,
                    'facet_counting_queries' => null,
                    'seo_url_parser_queries' => null,
                    'seo_url_generator_queries' => null,
                    'seo_url_index_queries' => null,
                    'seo_url_parser_logic' => null,
                    'ajax_activity_in_browser_console' => null,
                    'elastic_queries' => null,
                ],
                'experimental' => [
